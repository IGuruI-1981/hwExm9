...
//        ## Минимальный **уровень**
//
//        1. Необходимо создать класс Book, который содержит в себе данные об имени, авторе и годе публикации. Типы
//        полей должны быть String, Author (который мы создадим  в п. 2) и int.
...
//        (достаточно тоже двух) и инициализировать друг друга. Учесть, что авторы являются обязательными членами
//        книг и книги не могут создаться без авторов.
//
...
//        5. Объекты в методе main созданы.
        ...
        System.out.println("fet.firstName= " + fet.firstName);
        System.out.println("fet.secondName= " + fet.secondName);
        System.out.println("pushkin.firstName= " + pushkin.firstName);
        System.out.println("pushkin.secondName= " + pushkin.secondName);
